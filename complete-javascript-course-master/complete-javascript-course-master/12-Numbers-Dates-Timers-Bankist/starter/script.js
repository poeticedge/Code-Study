...
btnSort.addEventListener('click', function (e) {
  e.preventDefault();
  displayMovements(currentAccount.movements, !sorted);//acc?
  sorted = !sorted;
});
...
//console.log(Number.parseInt('30px', 10));//string has to start with a number wouldn't work with ('e23')
//console.log(Number.parseFloat('2.5rem'));//global functions
...
//parse from a string
//console.log(new Date ('Aug 20 2020'));//can be unreliable
